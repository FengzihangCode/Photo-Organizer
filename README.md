...
>
> 脚本**仅支持处理以下常见的照片格式**：JPG、ARW、NEF、ORF、RW2、RAF 和 DNG，如果需要处理其他格式的文件或指定不同的目录，请参考脚本中的参数化部分，并相应修改。
>
...
> [!IMPORTANT]
> 该App目前正处于开发阶段，因此**部分功能尚未实现**，应用程序也**不一定能完全按预期运行**，作者对应用程序出现问题导致的意外不承担任何责任
### 功能
#### 按拍摄日期整理
根据拍摄日期创建文件夹，并将照片移动到相应的日期文件夹中。
#### 按文件格式整理
...
添加帮助文档、关于✅、设置✅
### 已知问题
显示的语言会不时在简体中文和English时间横跳

> [!TIP]
> 一点作者的备注
>
> 这个脚本用于整理作者在运动会期间拍摄的照片
>
> 然后就逐渐变成了这个应用程序
>
> 谢谢你能看到这里
